...
## **Overview**
This document provides a detailed overview of the IPSec VPN configuration and deployment guidance, binded with a Hub and Spoke architecture, with the all required routing tables and routing rules.

<img src="images/dns-configuration.png" width="900" height="value">

&nbsp;

This document provides configuration for two routing types:
- BGP dynamic routing
- Static routing
